	...
	var Query = RichBase.extend({
		...
		statics : {
			...
			get_ifAllowScrollToMore : function(){
				if(typeof this.ifAllowScrollToMore=="undefined") this.ifAllowScrollToMore = true;
				return this.ifAllowScrollToMore;
			},
			set_ifAllowScrollToMore : function(boolean){
				this.ifAllowScrollToMore = boolean;
			},
		...
		getMore : function(){
			var that = this;
			var ifAllowScrollToMore = this.statics.get_ifAllowScrollToMore();
			if(!this.statics.hasMore || this.statics.dataIsLoading || !ifAllowScrollToMore) return false;
			var listUl = this.listUl;
		...
		updateListUl : function(data,type){
			...
			var listUl = this.listUl;
			var maxPage = this.statics.SCROLL_TO_GETMORE_MAX_PAGE;
			var currentPage = this.statics.getCurrentPage();
