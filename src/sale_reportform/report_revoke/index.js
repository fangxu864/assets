...
var Book_form={
    ...
    resellerAndTicket : function(data){     //处理分销商与票类情况
        ...
        theadHtml='<th class="th1">分销商名称</th> <th class="th2">景区门票名称</th><th class="th3">订单数</th> <th class="th4">撤改撤销票数</th> <th class="th5">退票收入(元)</th> <th class="th6">退票支出(元)</th> <th class="th7">退票手续费收入(元)</th> <th class="th8">退票手续费支出(元)</th>';
