...
var productposter =function(){
    ...
    this.selectTpl =   '<div class="selectwrap">'+
                ...
                '<button class="selectEnter">确定产品</button>'+
                '</div>';
        ...
        $.ajax({
            ...
            success:function(res){
                ...
                if(res.code==200){
                    ...
                    console.log("xy保存成功");
                    // that.dpic.attr("src",'/wechat/proPoster/'+'3385-'+id+'-'+sid);
                }else{
                    alert(res.msg);
                }
            }
...
//获取的我产品海报列表
$.ajax({
    url:"/r/Mall_Poster/myProPosters/",
    type:"POST",
    dataType:"json",
    data:{
        "page" : 1,
