...
var HeaderWarning={
    ...
    dialogCon:{
        ...
        "203": {
            ...
            "content":"亲爱的用户，自2017年2月17日起，票付通将对平台账户余额低于0元的用户进行使用限制，为确保您帐号的正常使用，请注意及时充值！",
            "isBtn_close":true ,
            "dialog_type": "recharge"
        },
        "204": {
    ...
    loopTipCon:{
        ...
        "203" : " 账户余额温馨提示：亲爱的用户，自2017年2月17日起，票付通将对平台账户余额低于0元的用户进行使用限制，为确保您帐号的正常使用，请注意及时充值！",
        "204" : " 账户余额温馨提示：亲爱的用户，自2017年2月17日起，票付通将对平台账户余额低于0元的用户进行使用限制，为确保您帐号的正常使用，请注意及时充值！",
        "205" : " 账户余额温馨提示：亲爱的用户，自2017年2月17日起，票付通将对平台账户余额低于0元的用户进行使用限制，为确保您帐号的正常使用，请注意及时充值！",
        "206" : " 账户余额温馨提示：亲爱的用户，自2017年2月17日起，票付通将对平台账户余额低于0元的用户进行使用限制，为确保您帐号的正常使用，请注意及时充值！"
    },
