                ...
                <ul class="listUl">
                    <li v-if="ticket.tourMsg.length>0" class="ticketLi" v-for="ticket in list">
                        ...
                        <div class="idcardItem" v-for="tour in ticket.tourMsg">
                            <input type="text" growing-ignore="true" class="nameInp" :placeholder="'游客姓名'+($index*1+1)" v-model="tour.name"/>
                            <input type="text" growing-ignore="true" class="idcardInp" placeholder="身份证" v-model="tour.idcard"/>
                        </div>
                    </li>
                </ul>
            </div>
