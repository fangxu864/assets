...
<style lang="sass">
    ...
    #productListUl .itemRow .botBox .col.lt{ float:left; width:70%; line-height:50px; overflow:hidden; font-size:0.35rem;}
    ...
    #productListUl .itemRow .botBox .col.rt .tprice{  text-decoration:line-through; font-size:0.3rem; margin-right:3px}
