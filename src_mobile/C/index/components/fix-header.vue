<template>
    <fix-header>
        <a class="leftBtn" href="javascript:void(0)" @click="onCityBtnClick" slot="left">
            <i class="iconfont icon-sevenbabicon31"></i>
            <span class="t" v-text="area"></span>
        </a>
...
<script type="es6">
    export default {
        ...
        methods : {
            onCityBtnClick(){
                console.log("onCityBtnClick");
                this.$dispatch("openCitySwitchor");
            }
        },
        components : {
