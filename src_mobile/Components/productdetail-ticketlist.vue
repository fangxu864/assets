<template>
    <div id="ticketListContainer" class="ticketListContainer">
...
<style lang="sass">
    #ticketListContainer .ticketList{ overflow:hidden; transition:height 0.1s}
    ...
    #ticketListContainer .switchBtn{ height:32px; line-height:32px; text-align:center; background:#fff; border-bottom:1px solid #dbdbdb}
